...
```    
       ...
       2.	UI filtering is not supported when using on-demand paging by setting [UseOnDemandPaging](https://help.syncfusion.com/cr/wpf/Syncfusion.UI.Xaml.Controls.DataPager.SfDataPager.html?_gl=1*wnqfc6*_gcl_au*MTI4MDY3NDQyLjE3NTU1MzQ0MTguMTE1MTc0ODg1Mi4xNzU4MDk2MjU4LjE3NTgwOTYyNTg.*_ga*MTc5NTY1NjM3MC4xNzQ4NTE1Njcz*_ga_41J4HFMX1J*czE3NTgyOTEwMjUkbzI2MSRnMSR0MTc1ODI5MjM3OSRqNTkkbDAkaDA.#Syncfusion_UI_Xaml_Controls_DataPager_SfDataPager_UseOnDemandPaging) to true.
```
